...
//low values testing lower latency
var audio_buffer_maximal_length_sec=3; //1.4; //actual number of samples are calculated from sample rate
var audio_buffer_decrease_to_on_overrun_sec=2.2; //1.0;
var audio_flush_interval_ms=500   //300; //the interval in which audio_flush() is called
