...
parser.add_argument("-d", "--day", type=str,
                help="20200930")
parser.add_argument("-ts", "--timestamp", type=str,
                help="1305")
...
receiver_name="start time "+str(day)+" "+str(timestamp)
receiver_location="Graz Lustbuehel"
receiver_qra=""
receiver_asl=0
receiver_ant="File"
receiver_device="File"
receiver_admin=""
...
format_conversion="csdr_old convert_u8_f"
...
iq_server_port = port+50 #TCP port for ncat to listen on. It will send I/Q data over its connections, for internal use in OpenWebRX. It is only accessible from the localhost by default.
